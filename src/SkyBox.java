...
public class SkyBox {
	...
	public static final String PATH_TO_TEXTURES = "textures/";
	...
	protected void loadTextures() {
		...
		for ( int i = 0; i < NUM_FACES; ++i ) {
			...
			try {
				...
				System.err.println( "Unable to load texture: " + PATH_TO_TEXTURES
						+ skybox_name + "/" + skybox_name + SKYBOX_SUFFIXES[ i ] + e.getMessage() );
			}
		}
	}
